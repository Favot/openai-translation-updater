...
import { getStagedTranslationFiles } from '../getStagedTranslationFiles';
import { noTranslationUpdatesFound } from '../getTranslationFiles';
...
describe('getChangedTranslationFiles', () => {
  ...
  it('should skip if no translation file updates are found', async () => {
    ...
    await expect(
      getStagedTranslationFiles({ defaultLanguage: 'en' }),
